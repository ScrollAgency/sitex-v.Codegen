...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: fMMSOkbWmL02/css
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__bStP)}
                    value={"item1"}
                  />

                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__jFNq)}
                    label={"Item 2"}
                    value={"item2"}
                  />
