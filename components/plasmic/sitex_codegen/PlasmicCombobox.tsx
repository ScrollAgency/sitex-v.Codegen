...
import MenuPopover from "../../MenuPopover"; // plasmic-import: fMMSOkbWmL02/component
import MenuItem from "../../MenuItem"; // plasmic-import: PiqWD2EdDkvf/component
import MenuSection from "../../MenuSection"; // plasmic-import: ZS-iIBSCTv7j/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: XzRzZOklX2hV/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__niPi1)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__iyxnw)}>
            <ChevronDown2Icon
