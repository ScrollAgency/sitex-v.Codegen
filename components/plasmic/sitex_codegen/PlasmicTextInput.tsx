...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: p2wlGiF5nbRC/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__wmNMp)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__hEbdS)}
              role={"img"}
            />
          ),
