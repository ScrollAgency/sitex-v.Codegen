...
import Radio from "../../Radio"; // plasmic-import: 6ufcUUBdY9Hy/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: rgg4MFD9GPsV/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__eTf6Q)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__sVux5)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__gpar8)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__gdrmd)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
