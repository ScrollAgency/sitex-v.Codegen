...
import Button from "../../Button"; // plasmic-import: 4KOd_In-K8MH/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: ZATh9TdHim4-/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_fadqN2EMctM9"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__fqRDd)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__bvk9X)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__z16Hj)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__piVh)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__rQD4)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
