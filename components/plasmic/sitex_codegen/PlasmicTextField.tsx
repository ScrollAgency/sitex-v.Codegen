...
import TextInput2 from "../../TextInput2"; // plasmic-import: MZN4BLyoheqJ/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 3n_9LmZq17IG/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: Q2lkJ6Ej0giH/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__imRma, {
          [sty.freeBoxiconEnd__imRma5RkWy]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__imRmArNcza]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__imRmavaAre]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hH6Gh, {
            [sty.freeBoxiconStart__hH6GhrNcza]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__hH6GhVaAre]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__m5X41)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__igPp6, {
            [sty.freeBoxiconEnd__igPp65RkWy]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__igPp6RNcza]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vXaN)}
                role={"img"}
              />
            ),
