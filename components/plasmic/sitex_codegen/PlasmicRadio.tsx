...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 6ufcUUBdY9Hy/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___5MxoE)}>
        <div className={classNames(projectcss.all, sty.freeBox__sx8Tc)} />
      </div>
      {renderPlasmicSlot({
