...
import Checkbox from "../../Checkbox"; // plasmic-import: hN6wZZUk92ow/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: u2kfEbJo8pzC/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__ub0Mc)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__qtWek)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ktwD1)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__mIoXo)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
