...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: PiqWD2EdDkvf/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__niK0B)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___0Tf9B)}>
            <div
              className={classNames(
                projectcss.all,
