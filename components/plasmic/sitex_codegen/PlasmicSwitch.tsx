...
import { DarkmodeValue, useDarkmode } from "./PlasmicGlobalVariant__Darkmode"; // plasmic-import: CHVB5T2Pfapv/globalVariant
...
import sty from "./PlasmicSwitch.module.css"; // plasmic-import: owBwgGMeYLEE/css
...
export type PlasmicSwitch__VariantsArgs = {
  zaeaze?: SingleBooleanChoiceArg<"zaeaze">;
};
type VariantPropType = keyof PlasmicSwitch__VariantsArgs;
export const PlasmicSwitch__VariantProps = new Array<VariantPropType>("zaeaze");
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.zaeaze
      }
    ],
    [$props, $ctx, $refs]
  );
  ...
  return (
    <BaseSwitch
      ...
      className={classNames(
        ...
        sty.ariaSwitch,
        {
          [sty.ariaSwitchglobal_darkmode_light]: hasVariant(
            globalVariants,
            "darkmode",
            "light"
          ),
          [sty.ariaSwitchzaeaze]: hasVariant($state, "zaeaze", "zaeaze")
        }
      )}
      ...
      >
        <div
          ...
          className={classNames(projectcss.all, sty.switchIndicator, {
            [sty.switchIndicatorzaeaze]: hasVariant($state, "zaeaze", "zaeaze")
          })}
        >
          <div
            ...
            className={classNames(projectcss.all, sty.thumb, {
              [sty.thumbzaeaze]: hasVariant($state, "zaeaze", "zaeaze")
            })}
          />
        </div>
        {$props.showLabel
